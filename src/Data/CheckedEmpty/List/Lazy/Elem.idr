...
module Data.CheckedEmpty.List.Lazy.Elem
...
public export
indexElem : Nat -> (xs : LazyLst ne a) -> Maybe (x ** Elem x xs)
indexElem  _    []        = Nothing
...
export
elemMap : {0 xs : LazyLst ne a} -> (0 f : a -> b) ->
